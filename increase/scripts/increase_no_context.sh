...
intersectBed -a ${output_folder}/mutations.bed.gz -b ${nodyads} -sorted | \
    gzip > ${output_folder}/mutations_intersect.bed.gz

python ${increase_dir}/expected_nucleosomes.py ${genome} ${output_folder}/mutations_intersect.bed.gz \
